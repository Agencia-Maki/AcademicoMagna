...
const NewExam = () => {
  ...
  return (
    <CRow>
      ...
      {exam.type_exam === 'automatic' && <ExamAuto exam={exam} setExam={setExam} id_program={id_program} />}
      {exam.type_exam === 'manual' && <ExamManual exam={exam} setExam={setExam} id_program={id_program} />}
    </CRow>
  )
}
