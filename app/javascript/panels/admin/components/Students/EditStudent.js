...
const EditStudent = () => {
  ...
  const { getModel, updateModel } = useCrud('/panel/admin/students/' + id_student, '/alumnos')
  const { data, handleChange } = useChange(student)
  const { first_name, last_name, document_number, document_type, email, phone, gender, avatar, status } = data;
