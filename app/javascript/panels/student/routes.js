...
const routes = [
  ...
  { path: '/programas/:program_id/evaluaciones', exact: true, name: 'Evaluaciones', element: Courses },
  { path: '/programas/:program_id/evaluaciones/:exam_id/resolver', exact: true, name: 'Resolver', element: Courses },
  { path: '/programas/:program_id/evaluaciones/:exam_id/mis_notas', exact: true, name: 'Calificar', element: Courses },
];
